                    ...
                    >
                      ...
                      {dayTasks.length > 0 && (
                        <div className="flex gap-0.5">
                          {hasCompleted && (
                            <div
                              className={`size-1.5 rounded-full ${isSelected ? "bg-primary-foreground" : "bg-emerald-500"}`}
                            />
                          )}
                          {hasPending && (
                            <div
                              className={`size-1.5 rounded-full ${isSelected ? "bg-primary-foreground/60" : "bg-amber-500"}`}
                            />
                          )}
                        </div>
                      )}
