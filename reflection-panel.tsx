      ...
      <div className="fixed inset-x-4 top-[5%] bottom-[5%] md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-2xl overflow-auto">
        <Card className="h-full flex flex-col">
          <CardHeader className="flex-row items-center justify-between space-y-0 pb-4">
            <CardTitle className="text-xl">Daily Reflection & Insights</CardTitle>
          ...
          <CardContent className="flex-1 space-y-8 overflow-auto pb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 rounded-xl bg-primary/5 border border-primary/10">
                <div className="text-4xl font-semibold text-primary mb-1">{completedTasks.length}</div>
                <div className="text-sm text-muted-foreground">Tasks completed</div>
              </div>
              <div className="text-center p-4 rounded-xl bg-muted">
                <div className="text-4xl font-semibold mb-1">{Math.round((totalMinutes / 60) * 10) / 10}h</div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {rescheduledTasks.map((task) => (
                    <div key={task.id} className="p-3 rounded-lg bg-amber-500/5 border border-amber-500/10">
                      <div className="flex items-center gap-3">
